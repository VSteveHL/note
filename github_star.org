...
* introduction-to-bash-scripting                          :course:bash:shell:
https://github.com/bobbyiliev/introduction-to-bash-scripting
一份入门bash脚本的电子书

* Stroke                                                   :software:windows:
https://github.com/poerin/Stroke
鼠标手势
...
* Qv2ray                                             :software:crossplatform:
https://github.com/Qv2ray/Qv2ray
跨平台V2Ray客户端

* Front-End-Interview-Notebook                                    :interview:
https://github.com/CavsZhouyou/Front-End-Interview-Notebook
前端复习笔记

* school-of-sre                                                      :course:
https://github.com/linkedin/school-of-sre
SRE课程。SRE是指Site Reliability Engineer (网站可靠性工程师)

* TermuxArch                                                 :android:script:
...
* AssetStudio                                              :software:windows:
https://github.com/Perfare/AssetStudio
unity拆包工具

* aria2                                              :software:crossplatform:
https://github.com/aria2/aria2
下载器

* missing-semester-cn.github.io                                      :course:
...
* python-cheatsheet                                           :python:course:
https://github.com/gto76/python-cheatsheet
python技巧

* sharpkeys                                                :software:windows:
https://github.com/randyrants/sharpkeys
按键重映射

* Liberica                                           :software:crossplatform:
